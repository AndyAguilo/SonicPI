...
with_fx :reverb do |c|
  live_loop :jazzy_shuffled_progression do
    ...
    if get(:part_8_on)
      control c, room: get(:sendB_8), mix: get(:sendA_8)
      ...
      # --- Play the music ---
      synth :fm, note: chord(root, type), cutoff: rrand(80, 120), sustain: rrand(1.3, 4.6), realease: rrand(1.3, 1.6), amp: get(:amp_8)*rrand(1, 1)
